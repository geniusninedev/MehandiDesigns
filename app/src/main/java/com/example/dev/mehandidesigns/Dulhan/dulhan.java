...
public class dulhan extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewPage.setOnPageChangeListener(dulhan.this);
