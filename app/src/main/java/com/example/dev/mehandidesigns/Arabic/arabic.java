...
public class arabic extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewPage.setOnPageChangeListener(arabic.this);
